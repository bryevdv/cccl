...
private:
  ...
  {
    const auto __device_id = _CUDA_VMR::__get_current_cuda_device();
...
public:
  ...
  cuda_async_memory_resource()
      : __pool_(__get_default_mem_pool())
  {}

  cuda_async_memory_resource(int)       = delete;
  cuda_async_memory_resource(nullptr_t) = delete;
  ...
  //! @brief  Constructs the cuda_async_memory_resource from a \c cuda_memory_pool by calling pool_handle()
